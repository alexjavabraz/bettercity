...
//    	File f = new File("C:\\Users\\asimas\\Downloads\\teste_social_card_ingles.jpg");
//    	
//    	byte[] a = converterDataByte(f);
//    	
//    	converteByteArrayToFile2(a, "C:\\Users\\asimas\\Downloads\\teste_social_card_ingles_copiado2.jpg");
//		
...
//		System.out.println(removeAcentuacao(input));
    	...
    	System.out.println(descriptoBase64("MjIxOTk2MQ==")); //2219961
//    	
//    	String dir = "C:\\temp\\pdfs\\images\\";
//    	File base = new File(dir);
//    	File[] arquivos = base.listFiles();
//		
//		if(arquivos != null){
...
//		}
    ...
    /**
     * Remove todos caracteres que nao forem letra ou numero da string <code>str</code>. <br/>
     * 
     * @param str
     * @return String somente com [a-zA-Z0-9]
     */
    ...
    /**
     * Remove todos caracteres !"#$%&'()*+,-./:;<=>?@[\]^_`{|}~ da string <code>str</code>. <br/>
     * 
     * @param str
     * @return String somente com [a-zA-Z0-9]
     */
    public static String removeCaracteresNaoLetras(String str) {
        if (isBlankOrNull(str))
            return str;
    ...
    public static boolean verificaAmbienteHomologacao() {
    	AmbienteEnum ambiente = AmbienteEnum.HMG;
        String runningMode = System.getProperty("runningMode");
        if (notEmpty(runningMode) && ambiente.getNmAmbiente().equals(runningMode)) {
            return true;
        }
    ...
    public static boolean verificaAmbienteDesenvolvimento() {
    	AmbienteEnum ambiente = AmbienteEnum.DEV;
        String runningMode = System.getProperty("runningMode");
        if (notEmpty(runningMode) && ambiente.getNmAmbiente().equals(runningMode)) {
            return true;
        }
    ...
    public enum AmbienteEnum implements Serializable {
        ...
        DEV("dev"), PI("pi"), PROD("prod"), HMG("hg");
    ...
    public static String convertBigDecimalToStringSemSeparador(BigDecimal d) {
        ...
        try {
            conv = format.format(d);
            conv = removeCaracteresEspeciais(conv);
            return conv;
        }
        catch (Exception e) {
            e.printStackTrace();
...
//			fileOuputStream.close();
	...
	public static File converteByteArrayToFile2(byte[] bFile, String diretorio) {
		try{
...
//		valorParcela            = valorParcela.add(valorParcela.multiply(percentual.divide(new BigDecimal(100))));
	...
	public static List<String> listarImagensDoCliente(Integer id,
			String caminhoProjetoTemp) {
		
		List<String> retorno = new ArrayList<String>();
		
		try{
			final String separador = System.getProperty("file.separator");
			File base       = new File(caminhoProjetoTemp+separador+id);
			File[] arquivos = base.listFiles();
			
			if(arquivos != null){
				for(File f : arquivos){
					retorno.add(id+separador+f.getName());
				}
			}
	...
	public static String formataValorParaWS(BigDecimal b){
		String retorno = "1";
